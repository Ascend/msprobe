...
class AdvisorConst:
    ...
    INPUT_SUGGEST = (
        "The input data of NPUDump is inconsistent with that of GroundTruth. Use the same data "
        "or check the data preprocessing process."
    )
    CONSISTENCY_SUGGEST = (
        "All data in the comparison result meets the accuracy requirements. "
    ...
    PROBLEM_SUGGEST = (
        "The accuracy of some tensors is low, resulting in an unqualified final accuracy. "
        "This may be caused by quantization. Calibrate the data or contact Huawei for further diagnosis. "
    )
    DEVIATION_SUGGEST = (
        "The accuracy of some tensors is low, while the final accuracy is qualified. "
