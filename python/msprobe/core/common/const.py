...
class CompareConst:
    ...
    HYPER_PARAM_NAME = "超参名称"
    KEY_PARAM_NAME = "关键参数名称"
    NPU_EFFECTIVE_VALUE = "NPU生效值"
    BENCH_EFFECTIVE_VALUE = "bench生效值"
    TARGET_EFFECTIVE_VALUE = "target生效值"
    IS_CONSISTENT = "是否一致"
    VERL_HYPER_PARAM_COMPARE_COLUM = [HYPER_PARAM_NAME, NPU_EFFECTIVE_VALUE, BENCH_EFFECTIVE_VALUE, IS_CONSISTENT]
    SLIME_HYPER_PARAM_COMPARE_COLUM = [HYPER_PARAM_NAME, NPU_EFFECTIVE_VALUE, BENCH_EFFECTIVE_VALUE, IS_CONSISTENT]
