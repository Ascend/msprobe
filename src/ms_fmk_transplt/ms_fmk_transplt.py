...
class MsFmkTransplt(object):
    ...
    def __para_check_valid(self, args):
        ...
        if utils.check_path_length_valid(input_path):
        ...
        if utils.check_path_length_valid(output):
    ...
    def __check_custom_rule_param_valid(args):
        ...
        if utils.check_path_length_valid(rule):
    ...
    def __check_distributed_rule_param_valid(args):
        ...
        if utils.check_path_length_valid(main_file):
