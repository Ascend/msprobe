...
当前，MindIE往往与[ATB加速库](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910/acce/ascendtb/ascendtb_0001.html)结合使用，达到最佳的推理性能。下文以MindIE+ATB为例，介绍MindIE场景下的精度问题定位方法。
