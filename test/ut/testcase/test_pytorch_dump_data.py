...
class TestUtilsMethods(unittest.TestCase):
    ...
    def test_get_dump_data_case1(self):
        ...
        with mock.patch('src.compare.pytorch_cmp.pytorch_dump_data.CompareData._check_data_type',
    ...
    def test_parse_dump_file(self):
        ...
        with mock.patch('src.compare.pytorch_cmp.hdf5_parser.Hdf5Parser.parse_dump_file',
