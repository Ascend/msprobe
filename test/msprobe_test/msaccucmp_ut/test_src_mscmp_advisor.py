...
class TestUtilsMethods(unittest.TestCase):
    ...
    @patch('cmp_utils.path_check.check_path_valid')
    def test_valid_file(self, mock_check_path_valid, mock_print_error_log):
        mock_check_path_valid.return_value = CompareError.MSACCUCMP_NONE_ERROR
        input_file = 'test.txt'
        file_type = '.txt'
        try:
        ...
        mock_check_path_valid.assert_called_once_with(input_file, True, False, PathType.File)
        mock_print_error_log.assert_not_called()

    @patch('cmp_utils.log.print_error_log')
    def test_invalid_file_type(self, mock_print_error_log):
        input_file = 'test.jpg'
        file_type = '.txt'
    ...
    @patch('cmp_utils.log.print_error_log')
    @patch('cmp_utils.path_check.check_path_valid')
    def test_invalid_input_file(self, mock_check_path_valid, mock_print_error_log):
        mock_check_path_valid.return_value = CompareError.MSACCUCMP_OPEN_FILE_ERROR
        input_file = 'test.txt'
        file_type = '.txt'
        with pytest.raises(CompareError) as error:
            _check_input_file(input_file, file_type)
