...
DEVICE_NUMBER = 8
BIN_FILE_PATH = os.path.join(os.path.abspath(os.path.dirname(__file__)), devicid + '/extract_file')
PARSED_FILE_PATH = os.path.join(os.path.abspath(os.path.dirname(__file__)), devicid + '/parsed_file')
COMBINE_FILE_PATH = os.path.join(os.path.abspath(os.path.dirname(__file__)), devicid + '/combine_file')
EXCEL_FILE_PATH = os.path.abspath(os.path.dirname(__file__)) + '/' + devicid
