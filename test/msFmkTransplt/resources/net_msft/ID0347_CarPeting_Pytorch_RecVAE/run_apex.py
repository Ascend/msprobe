...
def run(model, opts, train_data, batch_size, n_epochs, beta, gamma, dropout_rate):
    ...
    for epoch in range(n_epochs):
        for batch in generate(batch_size=batch_size, device=device, data_in=train_data, shuffle=True):
            ...
            prof.export_chrome_trace("simple_apex.prof")
...
model, optimizer_encoder = amp.initialize(model, optimizer_encoder, opt_level="O1")
model, optimizer_decoder = amp.initialize(model, optimizer_decoder, opt_level="O1")
